        ...
        <section className="h-screen w-screen relative after:bg-[#fff4] after:absolute after:top-0 after:left-0 after:bottom-0 after:right-0 backdrop-blur-sm after:z-10">
            <section className="absolute top-1/2 -translate-y-1/2 left-16 bg-red-0 z-30 uppercase">
                <section className={`${orbitron.className} text-[100px] text-black`}>
                    <p className="mb-8"><span className="text-redishMain">Explore</span> Kenya&apos;s</p>
                    <p>Stunning <span className="text-redishMain">Beauty</span></p>
                </section>
                <section className="mt-8">
                    <p></p>
                    <button className="py-5 px-12 flex gap-1 items-center justify-center bg-redishMain rounded-full hover:bg-[#fa3737ec] transition-all hover:gap-3 duration-[30ms]">Book now <FaArrowRight /></button>
                </section>
            </section>
